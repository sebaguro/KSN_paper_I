...
\begin{keyword}
   Kardashev scale \sep Astroinformatics \sep Baysian inference \sep Bitcoin
...
Figure~\ref{fig:panel_a} shows the Kardashev model (Eq.~\ref{eq:kardashev})
...
baseline of the data (Figure~\ref{fig:panel_a}).
...
Figure~\ref{fig:panel_c} shows $z(t)$ for 2009--2024, spanning 16 annual
...
to the KSN data is deferred to a future paper; Figure~\ref{fig:panel_c}
