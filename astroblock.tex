...
% =============================================================================
\section{Acknowledgments}
SG thanks R. Gamen from the New Virtual Observatory of Argentina (NOVA)
for the opportunity to serve as Argentina's representative on the
IVOA-exec committee from 2015 to 2024, and  C. Cui from the National Astronomical Observatories, (CAS) for encouragement during the preparation of this work. SG also thanks the support of colleagues from the IATE and the OAC. This work made use
...
NumPy.This research was partially conducted during a period of unpaid leave 
